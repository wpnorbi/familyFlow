...
3. When all PNG files are ready, register them with:
   `node scripts/register-generated-recipe-image-batch.mjs --batch tmp/recipe-image-generation-runs/missing-generated-images-source-fallback-0050/register-batch.template.json`
